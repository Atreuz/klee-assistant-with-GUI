...
import speech_recognition as sr #Libreria que convierte lo que escucha en texto (Reconocimiento de voz)
import openai
...
def main():
    ...
    hablar("Hola! Soy Klee tu loli personal, ¿en que puedo ayudarte?")
